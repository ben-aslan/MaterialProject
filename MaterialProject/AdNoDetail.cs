...
{
    public partial class AdNoDetail : Form
    {
        string _taskId;
        public AdNoDetail(string taskId)
        {
            InitializeComponent();
            _taskId = taskId;
        }

        private void AdNoDetails_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (var tasks = new TaskTableAdapter())
            {
                tasks.UpdateWithId("", adNotxt.Text, richTextBox1.Text, richTextBox2.Text, Convert.ToInt32(idtxt.Text));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (var tasks = new TaskTableAdapter())
            {
                tasks.Delete(Convert.ToInt32(idtxt.Text), "", adNotxt.Text);
        ...
        private void AdNoDetail_Activated(object sender, EventArgs e)
        {
            RefreshData();
        }
